class Lobby extends Phaser.Scene {
  ...
  renderUI() {
    ...
    this.p1Score = this.add.text(this.p1Avatar.x, this.p1Avatar.y + 80, '')
                          .setOrigin(0.5, 0.5)
                          .setFontSize(24).setFontFamily('Helvetica').setColor('#FF0000');

    this.p2Score = this.add.text(this.p2Avatar.x, this.p2Avatar.y + 80, '')
                          .setOrigin(0.5, 0.5)
                          .setFontSize(24).setFontFamily('Helvetica').setColor('#FF0000');
